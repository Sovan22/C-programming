...
/* Create one more 2D array and compare the two 2D arrays for values*/
    ...
    char twod_array[10][10];
    char twod_array2[10][10];
   ...
   printf("\nThe number of characters same in both the arrays is %d\n",count);
}